...
YOLO的迭代注重于主干、颈部、头部的网络架构不断优化，激活函数和损失函数持续升级，广泛吸收整合业界优秀模块经验，适配不同场景
尽管YOLO凭借其稳定性，基础性应用广泛，但在3D场景、边缘计算等方面仍有不足，短板集中在小目标检测、锚框限制、低算力设备部署
算法的优化涉及方方面面，要多学习他人优秀经验，大胆增删